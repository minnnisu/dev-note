...
만수무강 서비스에는 사용자가 음성 파일의 내용을 텍스트로 변환하여 서버에 녹음 파일과 변환된 텍스트를 함께 저장하는 기능을 제공하고 있습니다.

이 과정에서 음성 파일의 내용을 텍스트로 변환하기 위해 Whisper의 STT 기능을 외부 API로 함께 사용하여 개발하였습니다.
...
개선된 코드를 적용하여 Postman을 통해 음성 저장 API를 다시 호출해본 결과, 응답 시간이 100~200ms 수준으로 약 90% 개선되었습니다. 이로서 목표로 했던 1s 보다 더 빠른 응답 시간을 이끌어 낼 수 있었습니다.
